...
const CustomStyles = {
  Animations: {
    ...
    ButtonStyles: tw.button`bg-linear-gradient transition-transition-slide delay-slide-delay bg-[length:200%] hover:bg-[-100%_100%] hover:text-white cursor-pointer group text-red-50`,
  },
};
export { CustomStyles };
